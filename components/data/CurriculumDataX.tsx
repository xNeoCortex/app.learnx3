...
const WordBuilding = {
  ...
  questions: [
    {
      question:
        "Money can't buy you ______ or at least that's what some people say.",
      word: "happy",
      answers: "happiness",
    },
    {
  ...
  vocabularies: [
    {
      ...
      example:
        "She was extremely happy when she received the news of her promotion.",
    },
    {
      word: "suit",
      definition:
    ...
    },
    {
      ...
      example:
        "She showed sympathy towards her friend who was going through a difficult time.",
    },
  ],
}

export { curriculumX, lessonsX, WordBuilding, Vocabulary_1 }
