...
function EachCurriculum() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useQuery([`curriuclum-${id}`], () => fetchCurriculum(id))
  ...
  const curriculumLessons = fetchedLessons?.data?.filter((item) =>
    curriculum?.data?.lessons.includes(item.uid)
  )

  console.log("curriculum", curriculum)
  console.log("fetchedLessons", fetchedLessons)
  console.log("curriculumLessons", curriculumLessons)
              ...
              >
                ...
                >
                  ...
                  <Link
                    ...
                    to={`/class-curriculum/${id}/${x.category}/${x.uid}`}
                  >
                    <Button
                      style={{
                        background: "#5f61c4",
